...
RDEPENDS_${PN}_append_vuuno4k = " libgles-${MACHINE} kodiegl-${MACHINE}"
RDEPENDS_${PN}_append_vuuno4kse = " libgles-${MACHINE} kodiegl-${MACHINE}"
RDEPENDS_${PN}_append_vuultimo4k = " libgles-${MACHINE} kodiegl-${MACHINE}"
RDEPENDS_${PN}_append_vusolo2 = " libgles-${MACHINE} "
RDEPENDS_${PN}_append_vusolo4k = " libgles-${MACHINE} kodiegl-${MACHINE}"
